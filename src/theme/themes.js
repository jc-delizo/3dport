...
export const THEMES = [
  ...
  },
  {
    ...
    grammar: {
      ...
      button: 'rounded',
      display: 'sans-tight',
      // The signature is the drafting grid drawn behind everything (see
      // OrderGrid) plus the scatter->snap on first paint. Sections stay
      // bordered: the grid supplies the structure, so the rhythm must not
      // compete with it.
      signature: 'order',
      chart: {
        accent: '#BE3F28',
      ...
      approach: { pm: '#EAEEF4', mid: '#F6EFDF', eng: '#E9F1EA' },
    },
  },
  {
    id: 'throughput',
    ...
    grammar: {
      ...
      button: 'rounded',
      display: 'sans',
      // Bands keep the page quiet so the one moving thing is the delivery
      // rail (see ThroughputRail): work items advance lane by lane as the
      // reader scrolls, and the shipped count lands on the real figure.
      signature: 'throughput',
      tiles: { 'case-studies': 'lane', contact: 'lane' },
      chart: {
        accent: '#0B6E5B',
        surface: '#F2F5F8',
        grid: '#D6DEE6',
      ...
      approach: { pm: '#E8F0FA', mid: '#F3F0DE', eng: '#E2F1EA' },
    },
  },
  {
    id: 'signal',
    ...
    grammar: {
      ...
      button: 'pill',
      display: 'sans-tight',
      // Console rhythm: white instrument panels raised off a cool grey
      // canvas, so every section reads as a card on a board. The recessed
      // canvas between them is what makes the panels look lit.
      signature: 'signal',
      tiles: {
        hero: 'panel',
        proof: 'panel',
      ...
      approach: { pm: '#EAECFA', mid: '#F4F1E0', eng: '#E6F2EC' },
    },
  },
  {
    id: 'atrium',
    ...
    grammar: {
      ...
      button: 'pill',
      display: 'sans',
      // Real depth, no WebGL: each section is a plane on a CSS 3D stage that
      ...
      approach: { pm: '#E7EFFB', mid: '#F4F0DF', eng: '#E6F1EC' },
    },
  },
]
